...
export const CHARACTERS = {
  felix:   { name: 'Felix the Cat',          series: 'sil', year: 1919, film: 'Feline Follies',        top: 5, blurb: 'The first cartoon superstar. Keeps on walking.',
             stats: [['slv', 4, { t: 'perOwnColor', color: 'slv', n: 2 }], ['blu', 6, { t: 'front', n: 4 }], ['slv', 9, { t: 'minusOppColor', color: 'blu', n: 3 }], ['slv', 16, { t: 'plusAll', n: 2 }]] },
  gertie:  { name: 'Gertie the Dinosaur',    series: 'sil', year: 1914, film: 'Gertie the Dinosaur',   top: 4, blurb: 'The friendliest brontosaurus in vaudeville. Does tricks.',
             stats: [['grn', 3, { t: 'back', n: 3 }], ['grn', 7, { t: 'lonely', n: 5 }], ['grn', 8, { t: 'perOwnColor', color: 'grn', n: 2 }], ['grn', 13, { t: 'plusOwnColor', color: 'grn', n: 3 }]] },
  alfalfa: { name: 'Farmer Al Falfa',        series: 'sil', year: 1916, film: "Al Falfa's Catastrophe", top: 3, blurb: 'Grumpy, bearded, and forever losing to his own farm animals.',
             stats: [['yel', 3, { t: 'none' }], ['org', 6, { t: 'back', n: 4 }], ['yel', 8, { t: 'steal', n: 3 }], ['yel', 11, { t: 'perOppColor', color: 'grn', n: 3 }]] },
  koko:    { name: 'Koko the Clown',         series: 'ink', year: 1918, film: 'Out of the Inkwell',    top: 4, blurb: 'Climbs out of the inkwell every night to cause trouble.',
             stats: [['slv', 4, { t: 'x2', id: 'bimbo' }], ['prp', 6, { t: 'opp', n: 3 }], ['slv', 9, { t: 'mirror' }], ['slv', 13, { t: 'minusOppColor', color: 'red', n: 3 }]] },
  bimbo:   { name: 'Bimbo',                  series: 'ink', year: 1930, film: 'Hot Dog',               top: 3, blurb: 'A dog about town with big ears and bigger ideas.',
             stats: [['slv', 2, { t: 'perOwnColor', color: 'slv', n: 2 }], ['blu', 5, { t: 'first', n: 4 }], ['slv', 7, { t: 'lonely', n: 4 }], ['slv', 10, { t: 'plusOwnColor', color: 'slv', n: 2 }]] },
  betty:   { name: 'Betty Boop',             series: 'ink', year: 1930, film: 'Dizzy Dishes',          top: 5, blurb: 'The 1930 original, floppy ears and all. Boop-oop-a-doop!',
             stats: [['red', 4, { t: 'x2', id: 'bimbo' }], ['red', 7, { t: 'front', n: 4 }], ['red', 10, { t: 'plusOwnColor', color: 'red', n: 2 }], ['red', 15, { t: 'perOwnColor', color: 'red', n: 3 }]] },
  popeye:  { name: 'Popeye',                 series: 'thm', year: 1929, film: 'Thimble Theatre',       top: 5, blurb: 'He is what he is. Strong to the finish.',
             stats: [['blu', 5, { t: 'x2', id: 'olive' }], ['blu', 8, { t: 'opp', n: 4 }], ['blu', 10, { t: 'steal', n: 4 }], ['blu', 16, { t: 'opp', n: 8 }]] },
  olive:   { name: 'Olive Oyl',              series: 'thm', year: 1919, film: 'Thimble Theatre',       top: 3, blurb: 'Tall, tough and ten years older than Popeye.',
             stats: [['red', 2, { t: 'x2', id: 'popeye' }], ['red', 5, { t: 'back', n: 3 }], ['red', 7, { t: 'perOwnColor', color: 'blu', n: 2 }], ['red', 10, { t: 'plusOwnColor', color: 'blu', n: 2 }]] },
  oswald:  { name: 'Oswald the Lucky Rabbit', series: 'rub', year: 1927, film: 'Trolley Troubles',     top: 4, blurb: 'Lucky by name. Detachable by design.',
             stats: [['blu', 4, { t: 'lonely', n: 3 }], ['blu', 7, { t: 'front', n: 3 }], ['prp', 9, { t: 'minusOppColor', color: 'grn', n: 3 }], ['blu', 13, { t: 'plusOwnColor', color: 'blu', n: 3 }]] },
  willie:  { name: 'Steamboat Willie',       series: 'rub', year: 1928, film: 'Steamboat Willie',      top: 5, blurb: 'The 1928 deckhand who whistled his way into history.',
             stats: [['slv', 4, { t: 'first', n: 3 }], ['org', 7, { t: 'perOwnColor', color: 'org', n: 2 }], ['slv', 9, { t: 'back', n: 5 }], ['slv', 15, { t: 'plusAll', n: 2 }]] },
  bosko:   { name: 'Bosko',                  series: 'rub', year: 1929, film: "Sinkin' in the Bathtub", top: 3, blurb: 'The Talk-Ink Kid. Never stops singing.',
             stats: [['org', 3, { t: 'none' }], ['org', 6, { t: 'perOppColor', color: 'slv', n: 2 }], ['org', 8, { t: 'front', n: 4 }], ['org', 11, { t: 'plusOwnColor', color: 'org', n: 2 }]] },
  flip:    { name: 'Flip the Frog',          series: 'rub', year: 1930, film: 'Fiddlesticks',          top: 3, blurb: 'Fiddles, dances and hops out of every jam.',
             stats: [['grn', 3, { t: 'back', n: 2 }], ['grn', 6, { t: 'x2', id: 'bosko' }], ['grn', 8, { t: 'opp', n: 4 }], ['grn', 11, { t: 'perOwnColor', color: 'grn', n: 2 }]] },
  krazy:   { name: 'Krazy Kat',              series: 'fun', year: 1913, film: 'Krazy Kat',             top: 4, blurb: 'In love with a mouse who throws bricks. It is complicated.',
             stats: [['prp', 3, { t: 'x2', id: 'ignatz' }], ['prp', 6, { t: 'mirror' }], ['prp', 8, { t: 'lonely', n: 6 }], ['prp', 12, { t: 'minusOppColor', color: 'blu', n: 3 }]] },
  ignatz:  { name: 'Ignatz Mouse',           series: 'fun', year: 1913, film: 'Krazy Kat',             top: 3, blurb: 'One mouse. One brick. One target.',
             stats: [['slv', 2, { t: 'opp', n: 2 }], ['org', 5, { t: 'steal', n: 2 }], ['slv', 7, { t: 'opp', n: 5 }], ['slv', 10, { t: 'steal', n: 5 }]] },
  nemo:    { name: 'Little Nemo',            series: 'fun', year: 1905, film: 'Slumberland',           top: 4, blurb: 'Falls out of bed at the end of every adventure.',
