...
const ASSETS = [
  ...
  './js/app.js', './js/ui.js', './js/store.js', './js/game.js', './js/gtoons.js', './js/data.js', './js/art.js', './js/artwork.js', './js/pack.js', './js/sound.js', './js/news.js', './js/campaign.js', './js/story.js', './js/camp.js',
